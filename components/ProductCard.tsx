    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="w-10 h-10 rounded-full bg-gradient-to-r from-coffee-accent to-amber-600 text-amber-950 font-bold flex items-center justify-center shadow-md shadow-coffee-accent/20 hover:shadow-lg hover:shadow-coffee-accent/40 transition-shadow active:scale-95"
        >
